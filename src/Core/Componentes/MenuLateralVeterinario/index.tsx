...
const MunuVeterinario = () => {
  ...
  const handleRegistro = () => {
    navigate("/veterinario"); // Navega a la ruta de registro
  };

  const Citas = () => {
    navigate("/RegistroCitasevetrinario"); // Navega a la ruta de regitroCitas
  };

  const Tratamientos = () => {
    navigate("/RegistroTratamientovetrinario"); // Navega a la ruta de regitroTratamiento
  };

  const Mensajes = () => {
    navigate("/Mensajeveterinario"); // Navega a la ruta de mensaje
  };
